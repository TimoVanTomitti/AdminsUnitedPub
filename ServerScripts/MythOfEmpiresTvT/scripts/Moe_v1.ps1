...
### Configuration read ###
$scriptPath = $PWD
$plainPath = Split-Path -Path $PWD.Path -Parent
$ServerIni = "$($plainPath)\MoEconfigs\ServerParamConfig_All.ini"
...
$serverPath = $serverConfig['TvT_MoE_ServerControl']['serverPath']
