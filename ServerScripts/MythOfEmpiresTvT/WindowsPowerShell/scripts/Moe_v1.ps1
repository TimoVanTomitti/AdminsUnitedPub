...
$scriptPath = $PWD.Path
$planPath = Split-Path -Path $scriptPath -Leaf
$ServerIni = Join-Path -Path $scriptPath -ChildPath "\ServerParamConfig_All.ini"
...
Write-Host $serverConfig['TvT_MoE_ServerControl']['steamCMDPath']
Param (

    $steamCMDPath = $serverConfig['TvT_MoE_ServerControl']['steamCMDPath'],
    $rconPath = $serverConfig['TvT_MoE_ServerControl']['rconPath'],
    $scriptPath = $scriptPath,
    $privateIP = $serverConfig['TvT_MoE_ServerControl']['privateIP'],
    $publicIP = $serverConfig['TvT_MoE_ServerControl']['publicIP'],
    $clusterID = $serverConfig['TvT_MoE_ServerControl']['clusterID'],     
	$option = $serverConfig['TvT_MoE_ServerControl']['option'],
    $enableMySQL = $serverConfig['TvT_MoE_ServerControl']['enableMySQL'], 
    $enableDiscord = $serverConfig['TvT_MoE_ServerControl']['enableDiscord'],
    $discordSecret = $serverConfig['TvT_MoE_ServerControl']['discordSecret'],
    $autoprocess = $serverConfig['TvT_MoE_ServerControl']['autoprocess'],
    $restartTime = $serverConfig['TvT_MoE_ServerControl']['restartTime'],
    ## BANNING PARAMETERS
    $steamID = $serverConfig['TvT_MoE_ServerControl']['steamID'],
    $timeSpan = $serverConfig['TvT_MoE_ServerControl']['timeSpan'],
    $banreason = $serverConfig['TvT_MoE_ServerControl']['banreason']
)
